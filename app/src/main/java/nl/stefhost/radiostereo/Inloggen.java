...
public class Inloggen extends AppCompatActivity {
    ...
    private void inloggen_klaar() {
        ...
        if (resultaat.matches("NAAM")){
            ...
            SQLiteDatabase.execSQL("CREATE TABLE IF NOT EXISTS playlist (id INTEGER PRIMARY KEY, artiest text not null, titel text not null, album text, nummer text, online text not null, album_id text not null)");
